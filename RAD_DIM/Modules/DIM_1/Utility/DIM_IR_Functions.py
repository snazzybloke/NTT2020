...
This is the sixth script for the Data Investigation Module (DIM) imported by the Trigger.
...
def SingleAskBidColumnIR(mergedData):
    """
    Summary:
    -----------
    ...
    -----------
    mergedData : DataFrame
        current day IR data with ASKNEW, BIDNEW and MIDNEW columns
    """
